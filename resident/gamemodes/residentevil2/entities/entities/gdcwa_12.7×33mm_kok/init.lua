...
self.Penetrate 		= 17					// How deep Generic Default goes
self.Flightvector 	= self.Entity:GetUp()*((225*40.4)/66)	// Velocity in m/s, FIRST NUMMER is SPEED (FrameTime)
...
self.TissueDamage	= math.Rand(40,90)			// Player damage is multiplied by 2 for some reason
