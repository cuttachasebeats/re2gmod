...
SWEP.reloadinfo = 1                                   -- What kind of ammo
SWEP.ReloadSpeed = 1
...
function SWEP:Reload()
		...
		local waitdammit = ((self.Owner:GetViewModel():SequenceDuration()) + self.ReloadSpeed)
...
function SWEP:Silencer()
		...
		siltimer = CurTime() + ((self.Owner:GetViewModel():SequenceDuration()) + self.ReloadSpeed)
